                            ...
                            <div style="margin-left: 15px;">
                                ...
                                <div class="row justify-content-center">
                                    <li class="col-8 textoBlanco botonEncuestas">
                                        <router-link role="button" :to="{ name: 'Inicio' }" class="textoBlanco textoEncuestas">Proyectos&nbsp;&nbsp;<i class="text-white fas fa-project-diagram" style="cursor: pointer;"></i></router-link>
                                    </li>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card" style="border: none;" ref="cuadroLoader">
                                    <div class="encabezado">
                                        <ul style="text-align: left;">
                                            <router-link class="li agregarBlt linkResponsive" role="button" :to="{ name: 'Inicio' }"><span class="fas fa-project-diagram"></span> <span class="linkResponsiveCelular">Proyectos</span></router-link>
                                        </ul>
