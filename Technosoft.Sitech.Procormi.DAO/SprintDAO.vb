    ...
    Public Function PostSprintDAO(ByVal pSprintEn As SprintEN) As Reply(Of SprintEN)
        ...
        Try
            ...
            ElseIf pSprintEn IsNot Nothing Then
                sentence = "INSERT INTO sprint (Sprint_Name, Start_Date, End_Date, Id_Status, User_Login) VALUES (@parameter1, @parameter2, @parameter3,@parameter4, @parameter5)"

                ConexionDAO.Instancia.ExecuteInsertSprint(sentence, pSprintEn)
                reply.ok = True
                reply.msg = "Sprint insertado correctamente"
